...
export const FormInput = ({ maxWidth, placeholderCustom, isPass, onChangeInput }) => {
    ...
    return (
        <div className={`relative mt-5 h-[51px] group border border-dark-color rounded-lg focus-within:border-second-color duration-100 ${maxWidth} flex items-center justify-center`}>
            <input onChange={onChangeInput} type={!isPass ? "text" : (showPassword ? "text" : "password")} className="p-3 outline-none h-full w-full peer" required />
